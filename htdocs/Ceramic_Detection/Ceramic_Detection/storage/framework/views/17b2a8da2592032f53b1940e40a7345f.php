...
<body>
    <div class="register-container">
        ...
        <p class="links">Bạn đã có tài khoản? <a href="<?php echo e(route('login')); ?>">Đăng nhập</a></p>
    </div>
    ...
    <script>
        ...
        async function showTermsPopup() {
            ...
            try {
                const response = await fetch("<?php echo e(route('terms.show')); ?>");
...
</html><?php /**PATH D:\Xampp\htdocs\Ceramic_Detection\Ceramic_Detection\resources\views/register.blade.php ENDPATH**/ ?>