...
<body>
    <div class="container">
        ...
        <section class="gallery-section">
            ...
            <!-- Filter Section -->
            <form class="filter-section" method="GET" action="<?php echo e(route('gallery')); ?>">
                ...
                <select name="origin" style="--index: 2;">
                    ...
                    <?php $__currentLoopData = $origins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $org): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($org); ?>" <?php echo e(request('origin') == $org ? 'selected' : ''); ?>><?php echo e($org); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="gallery-list">
                <?php $__empty_1 = true; $__currentLoopData = $ceramics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ceramic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <article class="gallery-item" style="--index: <?php echo e($key + 1); ?>;">
                        <img src="<?php echo e($ceramic->image ? asset('storage/' . $ceramic->image) : 'https://via.placeholder.com/300x200'); ?>"
                            alt="<?php echo e($ceramic->name); ?>">
                        <div class="gallery-content">
                            <h2><?php echo e($ceramic->name); ?></h2>
                            <p><strong>Danh mục:</strong> <?php echo e($ceramic->category ?? 'Không có'); ?></p>
                            <p><strong>Nguồn gốc:</strong> <?php echo e($ceramic->origin ?? 'Không có'); ?></p>
                            <a href="<?php echo e(route('ceramics.show', $ceramic->id)); ?>">Xem chi tiết</a>
                        </div>
                    </article>
...
</html><?php /**PATH D:\Xampp\htdocs\Ceramic_Detection\Ceramic_Detection\resources\views/gallery.blade.php ENDPATH**/ ?>