...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="user-info">
                <h2>
                    Xin chào, <?php echo e(Auth::user()->name); ?>! Bạn còn <span id="tokenCount"><?php echo e(Auth::user()->tokens); ?></span>
                    lượt dự đoán.
                    <br>
        ...
        <div class="content-wrapper">
            ...
            <div class="section history-section" id="history" style="display: none;">
                ...
                <?php if($classifications->isEmpty()): ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $classifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo e(url($classification->image_path)); ?>" alt="Image"
                                            style="max-width: 100px; border-radius: 5px;">
                                    </td>
                                    <td><?php echo e($classification->result); ?></td>
                                    <td><?php echo e($classification->created_at->format('d/m/Y H:i')); ?></td>
                                    <td>
                                        <button class="view-info-btn" onclick="showInfoPopup(<?php echo e($classification->id); ?>)">
            ...
            <div class="section rating-section" id="rating" style="display: none;">
                ...
                <div class="current-rating">
                    ...
                    <div class="rating-stars current-stars">
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            <i class="fa-star <?php echo e($i <= (Auth::user()->rating ?? 0) ? 'fas' : 'far'); ?>"></i>
                        <?php endfor; ?>
                    </div>
                    <p><strong>Feedback:</strong> <?php echo e(Auth::user()->feedback ?? 'Bạn chưa gửi phản hồi.'); ?></p>
                </div>
            ...
            <div class="popup" id="changeNamePopup">
                ...
                <div id="changeNameContent">
                    <p>Tên hiện tại: <strong><?php echo e(Auth::user()->name); ?></strong></p>
            ...
            <script>
                const userId = "<?php echo e(Auth::user()->id ?? 'anonymous'); ?>";
                let tokens = <?php echo e(Auth::user()->tokens ?? 0); ?>;
                ...
                async function predictImage() {
                    ...
                    try {
                        const response = await fetch('<?php echo e(route('predict.image')); ?>', {
                            method: 'POST',
                            body: formData
                        });
                ...
                const allUserRatings = <?php echo json_encode($allUserRatings, 15, 512) ?>;
...
</html><?php /**PATH D:\Xampp\htdocs\Ceramic_Detection\Ceramic_Detection\resources\views/dashboard.blade.php ENDPATH**/ ?>