...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/HistoryDetection.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/Terms.css')); ?>">
    <!-- <link rel="stylesheet" href="<?php echo e(asset('css/llm.css')); ?>"> -->
    <style>
        :root {
...
<body>
        ...
        <ul>
            ...
            <li>
                <a href="#" data-tab="recharge">
                    ...
                    <?php if($rechargeRequests->isNotEmpty()): ?>
            ...
            <li>
                <a href="#" data-tab="contacts">
                    ...
                    <?php if($contacts->where('is_read', false)->isNotEmpty()): ?>
                        <span class="notification-dot"></span>
                    <?php endif; ?>
                </a>
            </li>
    ...
    <div class="content">
            ...
            <<h1>Tổng Quan</h1>
                ...
                <div class="stats-row">
                    ...
                    <div class="stat-card">
                        ...
                        <p><?php echo e($rechargeRequests->count()); ?></p>
                        <canvas id="rechargeTrendChart"></canvas>
                    </div>
                    <div class="stat-card">
                        <h3>Tổng doanh thu</h3>
                        <p><?php echo e(number_format($totalRevenue)); ?> VNĐ</p>
                ...
                <div class="stats-row">
                    <div class="stat-card">
                        ...
                        <p> Duyệt: <?php echo e($approvedRequests); ?> Hủy: <?php echo e($rejectedRequests); ?></p>
                        <canvas id="requestStatusPieChart"></canvas>
                    </div>
                    <div class="stat-card">
                        <h3>Đánh giá trung bình</h3>
                        <p><?php echo e(number_format($averageRating, 1)); ?>/5</p>
                        <canvas id="ratingTrendChart"></canvas>
                    </div>
                    <div class="stat-card">
                        <h3>Tổng lượt nhận diện</h3>
                        <p><?php echo e(number_format($totalTokenUsed)); ?></p>
                ...
                <div class="transaction-history">
                    ...
                    <form action="<?php echo e(route('admin.export.transaction.history')); ?>" method="GET"
                ...
                <div class="revenue-by-user">
                    ...
                    <?php else: ?>
                        <table>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $revenueByUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userId => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($data['name']); ?></td>
                                        <td><?php echo e(number_format($data['total_revenue'])); ?> VNĐ</td>
                                    </tr>
        ...
        <div class="container tab-content" id="contacts" style="display: none;">
            ...
            <?php endif; ?>
            <?php if(!isset($contacts) || $contacts->isEmpty()): ?>
                ...
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr
                                style="background-color: <?php echo e($contact->is_read ? 'var(--card-bg)' : 'rgba(42, 92, 139, 0.1)'); ?>; 
                                                                                                                                                                                                                                                                                                                                                                                                            color: <?php echo e($contact->is_read ? 'var(--text)' : 'var(--primary)'); ?>;
                                                                                                                                                                                                                                                                                                                                                                                                            border-left: 4px solid <?php echo e($contact->is_read ? 'transparent' : 'var(--secondary)'); ?>">
                                ...
                                <td>
                                    <span
                                        style="display: inline-block; 
                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                    border-radius: 12px;
                                                                                                                                                                                                                                                                                                                                                                                                                    background-color: <?php echo e($contact->is_read ? 'var(--border)' : 'var(--secondary)'); ?>;
                                                                                                                                                                                                                                                                                                                                                                                                                    color: <?php echo e($contact->is_read ? 'var(--text)' : 'var(--text-light)'); ?>;
                                                                                                                                                                                                                                                                                                                                                                                                                    font-size: 0.85rem;
                                                                                                                                                                                                                                                                                                                                                                                                                    font-weight: 500;">
                                        <?php echo e($contact->is_read ? 'Đã đọc' : 'Chưa đọc'); ?>

                                    </span>
                                </td>
                                <td>
                                    <button
                                        onclick="showContactPopup('<?php echo e($contact->id); ?>', '<?php echo e($contact->name); ?>', '<?php echo e($contact->phone); ?>', '<?php echo e($contact->email); ?>', '<?php echo e($contact->message); ?>', '<?php echo e($contact->is_read ? 'Đã đọc' : 'Chưa đọc'); ?>', <?php echo e($contact->is_read ? 'true' : 'false'); ?>)"
                ...
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="package-row-<?php echo e($package->id); ?>">
                                <form action="<?php echo e(route('recharge-packages.update', $package->id)); ?>" method="POST"
                                    class="edit-form" id="package-form-<?php echo e($package->id); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <td><?php echo e($package->id); ?></td>
                                    <td class="editable" data-field="amount">
                                        <span class="display"><?php echo e(number_format($package->amount)); ?></span>
                                        <input type="number" name="amount" value="<?php echo e($package->amount); ?>" style="display:none;"
                                            min="1000">
                                    </td>
                                    <td class="editable" data-field="tokens">
                                        <span class="display"><?php echo e($package->tokens); ?></span>
                                        <input type="number" name="tokens" value="<?php echo e($package->tokens); ?>" style="display:none;"
                                            min="1">
                                    </td>
                                    <td class="editable" data-field="description">
                                        <span class="display description-cell"
                                            id="description-<?php echo e($package->id); ?>"><?php echo e($package->description ?? 'Không có'); ?></span>
                                        <span class="toggle-description"
                                            onclick="togglePackageDescription('<?php echo e($package->id); ?>')"
                                            id="toggle-<?php echo e($package->id); ?>">Xem thêm</span>
                                        <textarea name="description"
                                            style="display:none;"><?php echo e($package->description); ?></textarea>
                                    </td>
                                    <td class="editable" data-field="is_active">
                                        <span
                                            class="display status <?php echo e($package->is_active ? 'active' : 'inactive'); ?>"><?php echo e($package->is_active ? 'Hoạt động' : 'Không hoạt động'); ?></span>
                                        <select name="is_active" style="display:none;">
                                            <option value="1" <?php echo e($package->is_active ? 'selected' : ''); ?>>Hoạt động</option>
                                            <option value="0" <?php echo e(!$package->is_active ? 'selected' : ''); ?>>Không hoạt động
                                            </option>
                                        </select>
                                    </td>
                                    <td class="actions">
                                        <button type="button" class="action-btn edit-btn"
                                            onclick="editPackageRow(<?php echo e($package->id); ?>)"><i class="fas fa-edit"></i>
                                            Sửa</button>
                                        <form action="<?php echo e(route('recharge-packages.update', $package->id)); ?>" method="POST"
                                        ...
                                        <button type="button" class="action-btn cancel-btn" style="display:none;"
                                            onclick="cancelPackageEdit(<?php echo e($package->id); ?>)"><i class="fas fa-times"></i>
                                            Hủy</button>
                                        <form action="<?php echo e(route('recharge-packages.destroy', $package->id)); ?>" method="POST"
                                            style="display:inline;" onsubmit="return confirm('Bạn có chắc muốn xóa gói này?');">
                                            <?php echo csrf_field(); ?>
                        ...
                        <tr id="row-<?php echo e($user->id); ?>">
                            ...
                            <td class="editable" data-field="name">
                                <span class="display user-name"
                                    onclick="showPopup('<?php echo e($user->id); ?>', '<?php echo e($user->name); ?>', '<?php echo e($user->rating ?? 0); ?>', '<?php echo e($user->feedback ?? 'Chưa có phản hồi'); ?>')"><?php echo e($user->name); ?></span>
                                <input type="text" name="name" value="<?php echo e($user->name); ?>" style="display:none;">
                            </td>
                            <td class="editable" data-field="email">
                                <span class="display"><?php echo e($user->email); ?></span>
                                <input type="email" name="email" value="<?php echo e($user->email); ?>" style="display:none;">
                            </td>
                            <td class="editable" data-field="role">
                                <span class="display"><?php echo e($user->role); ?></span>
                            ...
                            <td class="editable" data-field="tokens">
                                <span class="display"><?php echo e($user->tokens); ?></span>
                                <input type="number" name="tokens" value="<?php echo e($user->tokens); ?>" style="display:none;"
                                    min="0">
                            </td>
                            <td><?php echo e($user->tokens_used); ?></td>
                            <td class="editable" data-field="status"> <!-- New Status Field -->
                                <span
                                    class="display status <?php echo e($user->status); ?>"><?php echo e(ucfirst($user->status === 'active' ? 'Hoạt động' : 'Không hoạt động')); ?></span>
                                <select name="status" style="display:none;">
                                    <option value="active" <?php echo e($user->status === 'active' ? 'selected' : ''); ?>>Hoạt động
                                    </option>
                                    <option value="inactive" <?php echo e($user->status === 'inactive' ? 'selected' : ''); ?>>Không hoạt
                                        động</option>
                                </select>
                            </td>
                            <td class="actions">
                                <form action="<?php echo e(route('admin.update', $user->id)); ?>" method="POST" class="edit-form"
                                    id="form-<?php echo e($user->id); ?>" style="display:inline;">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <button type="button" class="action-btn edit-btn" onclick="editRow(<?php echo e($user->id); ?>)"><i
                                            class="fas fa-edit"></i> Sửa</button>
                                    <button type="submit" class="action-btn save-btn" style="display:none;"><i
                                            class="fas fa-save"></i> Lưu</button>
                                    <button type="button" class="action-btn cancel-btn" style="display:none;"
                                        onclick="cancelEdit(<?php echo e($user->id); ?>)"><i class="fas fa-times"></i> Hủy</button>
                                </form>
                                <form action="<?php echo e(route('admin.delete', $user->id)); ?>" method="POST" style="display:inline;"
                            ...
                            <td>
                                <button class="action-btn save-btn"
                                    onclick="showLoginHistory('<?php echo e($user->id); ?>', '<?php echo e($user->name); ?>')">
                                    <i class="fas fa-eye"></i> Xem
                                </button>
                            </td>
                        </tr>
        ...
        <div class="popup" id="addPackagePopup">
            ...
            <form id="addPackageForm" method="POST" action="<?php echo e(route('recharge-packages.store')); ?>">
                <?php echo csrf_field(); ?>
        ...
        <div class="container tab-content" id="recharge" style="display: none;">
            ...
            <?php if($rechargeRequests->isEmpty()): ?>
            ...
            <?php else: ?>
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $rechargeRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($request->id); ?></td>
                                <td><?php echo e($request->user->name); ?></td>
                                <td><?php echo e(number_format($request->amount)); ?> VNĐ</td>
                                <td><?php echo e($request->requested_tokens); ?></td>
                                <td>
                                    <?php if($request->proof_image): ?>
                                        <a href="<?php echo e(url('/storage/' . $request->proof_image)); ?>" target="_blank">
                                            <img src="<?php echo e(url('/storage/' . $request->proof_image)); ?>" alt="Proof"
                                ...
                                <td class="actions">
                                    <form action="<?php echo e(route('admin.recharge.approve', $request->id)); ?>" method="POST"
                                    ...
                                    <button type="button" class="action-btn reject-btn"
                                        onclick="showRejectPopup('<?php echo e($request->id); ?>', '<?php echo e($request->user->name); ?>')"><i
        ...
        <div class="container tab-content" id="ceramics" style="display: none;">
            ...
            <?php else: ?>
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $ceramics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ceramic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="ceramic-row-<?php echo e($ceramic->id); ?>">
                                <form action="<?php echo e(route('admin.ceramics.update', $ceramic->id)); ?>" method="POST"
                                    class="edit-form" id="ceramic-form-<?php echo e($ceramic->id); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <td><?php echo e($ceramic->id); ?></td>
                                    <td class="editable" data-field="name">
                                        <span class="display"><?php echo e($ceramic->name); ?></span>
                                        <input type="text" name="name" value="<?php echo e($ceramic->name); ?>" style="display:none;">
                                    </td>
                                    <td class="editable" data-field="description">
                                        <span class="display description-cell"
                                            id="description-<?php echo e($ceramic->id); ?>"><?php echo e($ceramic->description ?? 'Không có'); ?></span>
                                        <span class="toggle-description" onclick="toggleDescription('<?php echo e($ceramic->id); ?>')"
                                            id="toggle-<?php echo e($ceramic->id); ?>">Xem thêm</span>
                                        <textarea name="description"
                                            style="display:none;"><?php echo e($ceramic->description); ?></textarea>
                                    </td>
                                    <td class="editable image-cell" data-field="image">
                                        <span class="display">
                                            <?php if($ceramic->image): ?>
                                                <img src="<?php echo e(url('/storage/' . $ceramic->image)); ?>" alt="<?php echo e($ceramic->name); ?>"
                                                    style="max-width: 100px; border-radius: 5px;">
                                            <?php else: ?>
                                                Không có ảnh
                                            <?php endif; ?>
                                        </span>
                                        <input type="text" name="image" value="<?php echo e($ceramic->image); ?>" style="display:none;"
                                            placeholder="Đường dẫn hình ảnh (ceramics/ten_hinh.jpg)">
                                    </td>
                                    <td class="editable" data-field="category">
                                        <span class="display"><?php echo e($ceramic->category ?? 'Không có'); ?></span>
                                        <input type="text" name="category" value="<?php echo e($ceramic->category); ?>"
                                            style="display:none;">
                                    </td>
                                    <td class="editable" data-field="origin">
                                        <span class="display"><?php echo e($ceramic->origin ?? 'Không có'); ?></span>
                                        <input type="text" name="origin" value="<?php echo e($ceramic->origin); ?>" style="display:none;">
                                    </td>
                                    <td class="actions">
                                        <button type="button" class="action-btn edit-btn"
                                            onclick="editCeramicRow(<?php echo e($ceramic->id); ?>)"><i class="fas fa-edit"></i>
                                            Sửa</button>
                                        <form action="<?php echo e(route('admin.ceramics.update', $user->id)); ?>" method="POST"
                                            class="edit-form" id="form-<?php echo e($user->id); ?>">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <button type="submit" class="action-btn save-btn" style="display:none;"><i
                                                    class="fas fa-save"></i> Lưu</button>
                                        ...
                                        <button type="button" class="action-btn cancel-btn" style="display:none;"
                                            onclick="cancelCeramicEdit(<?php echo e($ceramic->id); ?>)"><i class="fas fa-times"></i>
                                            Hủy</button>
                                        <form action="<?php echo e(route('admin.ceramics.delete', $ceramic->id)); ?>" method="POST"
                                            style="display:inline;"
        ...
        <div class="container tab-content" id="settings" style="display: none;">
            <h1>Cài Đặt</h1>
            <?php echo $__env->make('llm_settings', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <h3>Sao Lưu Dữ Liệu</h3>
            <?php if(session('backup_success')): ?>
                <div class="success-message">
                    ...
                    <?php endif; ?>
                    <?php echo e(session('backup_success')); ?>

                </div>
            <?php endif; ?>
            <form method="POST" action="<?php echo e(route('admin.backup')); ?>">
                <?php echo csrf_field(); ?>
            ...
            <?php if(session('timezone_success')): ?>
                <div class="success-message">
                    <?php echo e(session('timezone_success')); ?>

                </div>
            <?php endif; ?>
            <form method="POST" action="<?php echo e(route('admin.settings.timezone')); ?>">
                <?php echo csrf_field(); ?>
                <div>
                    <label for="timezone">Chọn múi giờ:</label>
                    <select name="timezone" id="timezone" required>
                        <option value="" disabled <?php echo e(!isset($currentTimezone) ? 'selected' : ''); ?>>Chọn múi giờ</option>
                        <option value="UTC" <?php echo e(isset($currentTimezone) && $currentTimezone === 'UTC' ? 'selected' : ''); ?>>
                            UTC</option>
                        <option value="Asia/Ho_Chi_Minh" <?php echo e(isset($currentTimezone) && $currentTimezone === 'Asia/Ho_Chi_Minh' ? 'selected' : ''); ?>>Asia/Ho_Chi_Minh (Việt Nam,
                            GMT+7)</option>
                        <option value="Asia/Bangkok" <?php echo e(isset($currentTimezone) && $currentTimezone === 'Asia/Bangkok' ? 'selected' : ''); ?>>Asia/Bangkok (Thái Lan, GMT+7)</option>
                        <option value="Asia/Tokyo" <?php echo e(isset($currentTimezone) && $currentTimezone === 'Asia/Tokyo' ? 'selected' : ''); ?>>Asia/Tokyo (Nhật Bản, GMT+9)</option>
                        <option value="America/New_York" <?php echo e(isset($currentTimezone) && $currentTimezone === 'America/New_York' ? 'selected' : ''); ?>>America/New_York (Mỹ, GMT-5)
                        </option>
                        <option value="Europe/London" <?php echo e(isset($currentTimezone) && $currentTimezone === 'Europe/London' ? 'selected' : ''); ?>>Europe/London (Anh, GMT+0)</option>
                    </select>
                </div>
            ...
            <?php if(session('theme_success')): ?>
                <div class="success-message">
                    <?php echo e(session('theme_success')); ?>

                </div>
            <?php endif; ?>
            <form method="POST" action="<?php echo e(route('admin.settings.theme')); ?>">
                <?php echo csrf_field(); ?>
                <div>
                    <label>
                        <input type="radio" name="theme" value="index" <?php echo e($currentTheme === 'index' ? 'checked' : ''); ?>>
                        Giao diện 1 (Mặc định)
                    </label>
                    <label>
                        <input type="radio" name="theme" value="index2" <?php echo e($currentTheme === 'index2' ? 'checked' : ''); ?>>
            ...
            <?php if(session('captcha_success')): ?>
                <div class="success-message">
                    <?php echo e(session('captcha_success')); ?>

                </div>
            <?php endif; ?>
            <form method="POST" action="<?php echo e(route('admin.settings.captcha')); ?>">
                <?php echo csrf_field(); ?>
                <div>
                    <label for="recaptcha_enabled">
                        <input type="checkbox" id="recaptcha_enabled" name="recaptcha_enabled" value="1" <?php echo e($recaptchaEnabled ? 'checked' : ''); ?>>
                ...
                <tbody>
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($user->id); ?></td>
                            <td class="user-name"
                                onclick="showClassificationHistory('<?php echo e($user->id); ?>', '<?php echo e($user->name); ?>')">
        ...
        <div class="container tab-content" id="news" style="display: none;">
            ...
            <!-- Thông báo thành công (nếu có) -->
            <?php if(session('news_success')): ?>
                <div class="success-message">
                    <?php echo e(session('news_success')); ?>
                ...
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="news-row-<?php echo e($article->id); ?>">
                                <form action="<?php echo e(route('news.update', $article->id)); ?>" method="POST" class="edit-form"
                                    id="news-form-<?php echo e($article->id); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <td><?php echo e($article->id); ?></td>
                                    <td class="editable" data-field="title">
                                        <span class="display"><?php echo e($article->title); ?></span>
                                        <input type="text" name="title" value="<?php echo e($article->title); ?>" style="display:none;">
                                    </td>
                                    <td class="editable" data-field="excerpt">
                                        <span class="display"><?php echo e($article->excerpt ?? 'Không có'); ?></span>
                                        <input type="text" name="excerpt" value="<?php echo e($article->excerpt); ?>" style="display:none;">
                                    </td>
                                    <td class="editable image-cell" data-field="image">
                                        <span class="display">
                                        ...
                                        <input type="text" name="image" value="<?php echo e($article->image); ?>" style="display:none;"
                                            placeholder="Đường dẫn hình ảnh (news/ten_hinh.jpg)">
                                    </td>
                                    <td class="editable" data-field="content">
                                        <span class="display description-cell"
                                            id="content-<?php echo e($article->id); ?>"><?php echo e($article->content ?? 'Không có'); ?></span>
                                        <span class="toggle-description" onclick="toggleNewsContent('<?php echo e($article->id); ?>')"
                                            id="toggle-content-<?php echo e($article->id); ?>">Xem thêm</span>
                                        <textarea name="content" style="display:none;"><?php echo e($article->content); ?></textarea>
                                    </td>
                                    <td class="actions">
                                        <button type="button" class="action-btn edit-btn"
                                            onclick="editNewsRow(<?php echo e($article->id); ?>)"><i class="fas fa-edit"></i> Sửa</button>
                                        <button type="button" class="action-btn cancel-btn" style="display:none;"
                                            onclick="cancelNewsEdit(<?php echo e($article->id); ?>)"><i class="fas fa-times"></i>
                                            Hủy</button>
                                        <form action="<?php echo e(route('news.update', $article->id)); ?>" method="POST"
                                            style="display:inline;">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <button type="submit" class="action-btn save-btn" style="display:none;"><i
                                        ...
                                        <button type="button" class="action-btn cancel-btn" style="display:none;"
                                            onclick="cancelNewsEdit(<?php echo e($article->id); ?>)"><i class="fas fa-times"></i>
                                            Hủy</button>
                                        <form action="<?php echo e(route('news.delete', $article->id)); ?>" method="POST"
                                            style="display:inline;"
        ...
        <div class="container tab-content" id="system-info" style="display: none;">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <form method="POST" action="<?php echo e(route('admin.toggle-optimization')); ?>">
                    <?php echo csrf_field(); ?>
                    <label>
                        <input type="checkbox" name="optimization" <?php echo e($isSystemInfoEnabled ? 'checked' : ''); ?>
            ...
            <div class="tab-container">
                ...
                <div id="fastapi" class="tab-content active">
                    ...
                    <?php if($isSystemInfoEnabled): ?>
                        <div>
                            <h2>Tổng quan FastAPI</h2>
                            <ul>
                                <li>CPU Usage: <?php echo e($fastapistats['cpu_usage_percent'] ?? 0); ?>%</li>
                                <li>RAM Total: <?php echo e($fastapistats['ram_total_mb'] ?? 0); ?> MB</li>
                                <li>RAM Used: <?php echo e($fastapistats['ram_used_mb'] ?? 0); ?> MB</li>
                                <li>RAM Usage: <?php echo e($fastapistats['ram_usage_percent'] ?? 0); ?>%</li>
                                <li>GPU Usage: <?php echo e($fastapistats['gpu_usage_percent'] ?? 0); ?>%</li>
                                <li>GPU Total: <?php echo e($fastapistats['gpu_total_mb'] ?? 0); ?> MB</li>
                                <li>GPU Used: <?php echo e($fastapistats['gpu_used_mb'] ?? 0); ?> MB</li>
                                <?php if(isset($fastapistats['error'])): ?>
                                    <li>Lỗi: <?php echo e($fastapistats['error']); ?></li>
                                <?php endif; ?>
                            </ul>
                        </div>
    ...
    <div class="popup" id="addNewsPopup">
        ...
        <form id="addNewsForm" method="POST" action="<?php echo e(route('news.store')); ?>">
            <?php echo csrf_field(); ?>
    ...
    <div class="popup" id="addCeramicPopup">
        ...
        <form id="addCeramicForm" method="POST" action="<?php echo e(route('admin.ceramics.store')); ?>">
            <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function showRejectPopup(requestId, userName) {
            ...
            form.action = '<?php echo e(route("admin.recharge.reject")); ?>';
            popup.style.display = 'block';
            overlay.style.display = 'block';
        }
        ...
        function renderRevenueChart() {
            ...
            const labels = <?php echo json_encode($revenueLabels); ?> || ['Chưa có dữ liệu'];
            const data = <?php echo json_encode($revenueData); ?> || [0];
        ...
        document.addEventListener('DOMContentLoaded', function () {
            // Dữ liệu từ PHP
            const userTrend = <?php echo json_encode($userTrend, 15, 512) ?>;
            const rechargeTrend = <?php echo json_encode($rechargeTrend, 15, 512) ?>;
            const revenueTrend = <?php echo json_encode($revenueTrend, 15, 512) ?>;
            const ratingTrend = <?php echo json_encode($ratingTrend, 15, 512) ?>;
            const approvedRequests = <?php echo json_encode($approvedRequests, 15, 512) ?>;
            const rejectedRequests = <?php echo json_encode($rejectedRequests, 15, 512) ?>;
            const pendingRequests = <?php echo json_encode($rechargeRequests->count(), 15, 512) ?>;
            const activeUsers = <?php echo json_encode($activeUsers, 15, 512) ?>;
            const inactiveUsers = <?php echo json_encode($inactiveUsers, 15, 512) ?>;
            const revenueLabels = <?php echo json_encode($revenueLabels, 15, 512) ?>; // Dữ liệu ngày
            const revenueData = <?php echo json_encode($revenueData, 15, 512) ?>;
            const tokenTrend = <?php echo json_encode($tokenTrend, 15, 512) ?>;
            // Hàm tạo biểu đồ
        ...
        const classifications = <?php echo json_encode($classifications, 15, 512) ?>;
        ...
        const loginHistories = <?php echo json_encode($users->mapWithKeys(function ($user) {
        ...
        function updateContactNotification() {
            ...
            const unreadCount = <?php echo json_encode($contacts->where('is_read', false)->count(), 512) ?>; // Số liên hệ chưa đọc ban đầu
        ...
        function updateRechargeNotification() {
            ...
            const rechargeCount = <?php echo json_encode($rechargeRequests->count(), 15, 512) ?>; // Số lượng ban đầu từ PHP
            // Xóa dấu chấm cũ nếu có
            if (notificationDot) {
                notificationDot.remove();
            }
        ...
        const transactions = <?php echo json_encode($transactionHistory->toArray(), 15, 512) ?>;
...
</html><?php /**PATH D:\Xampp\htdocs\Ceramic_Detection\Ceramic_Detection\resources\views/admin.blade.php ENDPATH**/ ?>